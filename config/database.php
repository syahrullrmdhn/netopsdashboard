    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'port'      => env('DB_CUSTOMER_PORT', '8002'),
            'database'  => env('DB_CUSTOMER_DATABASE', 'customerdb'),
            'username'  => env('DB_CUSTOMER_USERNAME', 'networkdashboard'),
            'password'  => env('DB_CUSTOMER_PASSWORD', 'networkdashboard2025'),
            'charset'   => 'utf8mb4',
